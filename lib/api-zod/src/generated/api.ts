...
export const ListToursResponseItem = zod.object({
  ...
  "priceLabel": zod.string().nullish().describe('The label\'s own words, e.g. Starting from \/ Per Person. Null = site defaults.'),
  "showAdvertisedPrice": zod.boolean().optional(),
  "showGroupRates": zod.boolean().optional().describe('List the group rates on the trip page'),
