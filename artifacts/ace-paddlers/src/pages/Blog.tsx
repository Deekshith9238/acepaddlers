...
export default function Blog() {
  return <EditablePage slug="blog"><BlogContent /></EditablePage>;
}
  ...
  return (
    <>
      <PageMeta
        ...
        {/* Hero */}
        <PageHero page="blog" fallbackImage="/images/barpole-rafting-3.jpg">
          <Animate immediate variant="up" className="max-w-3xl mx-auto text-center">
