  ...
  return (
    <>
      <PageMeta
        ...
        />
        {/* Hero */}
        <PageHero page="about" fallbackImage="/images/badra-rafting-2.jpg"
          overlay="linear-gradient(to right, rgba(6,24,32,0.92) 0%, rgba(13,58,94,0.65) 60%, rgba(6,24,32,0.40) 100%)">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 bg-white rounded-2xl p-6 z-20 border shadow-lg"
                ...
                <div className="text-4xl font-bold mb-1" style={{ fontFamily: "var(--app-font-serif)", color: C.deepOcean }}>
                  87,000+
                </div>
        ...
        <section className="py-24 px-6" style={{ backgroundColor: C.deepOcean }}>
          <div className="max-w-7xl mx-auto text-white">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl mb-4" style={{ fontFamily: "var(--app-font-serif)" }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {CERTS.map((cert, i) => (
                <div key={i} className="rounded-2xl p-8 text-center"
                  ...
                  <div className="text-4xl font-bold mb-3" style={{ fontFamily: "var(--app-font-serif)", color: "#a8dff0" }}>
                    {cert.title}
                  </div>
              ...
              <div className="grid sm:grid-cols-2 gap-8 max-w-2xl mx-auto">
                {LEADERS.map((member, i) => (
                  <div key={i} className="group rounded-2xl overflow-hidden bg-white border transition-all duration-300 hover:-translate-y-1"
                    ...
                    <div className="p-6">
                      <h3 className="text-xl mb-3" style={{ fontFamily: "var(--app-font-serif)", color: C.text }}>
                        {member.name}
                      </h3>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {BACKBONE.map((member, i) => (
                  <div key={i} className="group rounded-xl overflow-hidden bg-white border transition-all duration-300 hover:-translate-y-1"
                    ...
                    <div className="p-4">
                      <h3 className="font-semibold mb-0.5" style={{ fontFamily: "var(--app-font-serif)", color: C.text }}>
                        {member.name}
                      </h3>
        ...
        <section className="py-16 px-6" style={{ backgroundColor: C.deepOcean }}>
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            {[
              ...
              <div key={i}>
                <div className="text-4xl font-bold mb-2" style={{ fontFamily: "var(--app-font-serif)", color: "#a8dff0" }}>
                  {s.val}
                </div>
